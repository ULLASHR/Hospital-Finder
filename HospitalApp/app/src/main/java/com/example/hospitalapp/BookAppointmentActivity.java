...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed2=findViewById(R.id.editTextAppContactNumber);
        ed3=findViewById(R.id.editTextAppFees);
        dateButton=findViewById(R.id.buttonAppDate);
        timeButton=findViewById(R.id.buttonAppTime);
        btnBookApp=findViewById(R.id.buttonAppBookAppointment);
        ...
        btnBookApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.addOrder(username,title+" => "+fullname, "",contact,0,dateButton.getText().toString(),timeButton.getText().toString(),Float.parseFloat(fees),"appointment");

                Toast.makeText(getApplicationContext(),"Your booking is done successfully",Toast.LENGTH_LONG).show();
                startActivity(new Intent(BookAppointmentActivity.this,HomeActivity.class));

//                if(db.checkAppointmentExists(username,title+" => "+fullname,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
